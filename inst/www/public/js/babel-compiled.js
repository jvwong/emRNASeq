...
(function () {
  boot.initModule();
  // shell.initModule("http://opencpu:8004/ocpu/library/emRNASeq/R", $('#em'));
  shell.initModule("", $('#em'));
})();
